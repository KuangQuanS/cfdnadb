        ...
        <div className="gdc-hero-inner gdc-hero-inner--intro">
          <div className="gdc-col-left">
            ...
            <div className="gdc-subtitle">
              <p>
                ctDNA Database provides a comprehensive resource for plasma circulating tumor DNA somatic mutation profiles across multiple cancer types generated by high-throughput sequencing and collected from <span className="gdc-subtitle-keyword">more than 10 hospitals across multi-center cohorts</span>, covering <span className="gdc-subtitle-stat">10,455 samples</span> (<span className="gdc-subtitle-stat">3,306 collected</span> and <span className="gdc-subtitle-stat">7,149 publicly available</span>), <span className="gdc-subtitle-stat gdc-subtitle-stat--variant">52,913,259 variants</span>, and <span className="gdc-subtitle-stat">16 cancer types</span>. It classifies <span className="gdc-subtitle-stat gdc-subtitle-stat--variant">50,522,019 variants</span> with mapped genomic locations, including <span className="gdc-subtitle-term">23,901,156 intergenic</span>, <span className="gdc-subtitle-term">17,771,249 intronic</span>, <span className="gdc-subtitle-term">4,199,697 exonic</span>, and <span className="gdc-subtitle-term">646,446 UTR variants</span>, and annotates <span className="gdc-subtitle-stat gdc-subtitle-stat--mutation">3,139,073 protein-altering mutations</span>, including <span className="gdc-subtitle-term">2,836,847 nonsynonymous SNVs</span>, <span className="gdc-subtitle-term">141,734 stopgain</span>, <span className="gdc-subtitle-term">148,901 frameshift</span>, and <span className="gdc-subtitle-term">9,319 nonframeshift</span> events. The database supports integrated analyses of <span className="gdc-subtitle-keyword">somatic mutations</span>, <span className="gdc-subtitle-keyword">variant allele frequency (VAF)</span>, <span className="gdc-subtitle-keyword">oncoplots</span>, <span className="gdc-subtitle-keyword">transition/transversion (Ti/Tv) patterns</span>, and <span className="gdc-subtitle-keyword">survival outcomes</span>, while also incorporating <span className="gdc-subtitle-keyword">DNA methylation</span>, <span className="gdc-subtitle-keyword">circulating tumor cells (CTCs)</span>, <span className="gdc-subtitle-keyword">histone modifications</span>, and <span className="gdc-subtitle-keyword">nucleosome positioning</span> to help assess the functional effects of mutated genes.
              </p>
            </div>
