...
const ALL_CALLOUTS = [
  ...
  { id: "Liver", label: "Liver", side: "left", topPct: 39, anchorPct: 43, browseKey: "Liver", alwaysShow: true },
  { id: "Kidney", label: "Kidney", side: "left", topPct: 44, anchorPct: 43, browseKey: "Kidney", alwaysShow: false },
  { id: "Endometrial", label: "Endometrial", side: "left", topPct: 54, anchorPct: 48, browseKey: "Endometrial", alwaysShow: false },
  { id: "Bladder", label: "Bladder", side: "left", topPct: 60, anchorPct: 50, browseKey: "Bladder", alwaysShow: false },
  /* ── right side (top → bottom) ── */
  { id: "Breast", label: "Breast", side: "right", topPct: 31, anchorPct: 60, browseKey: "Breast", alwaysShow: true },
  { id: "Gastric", label: "Gastric", side: "right", topPct: 40, anchorPct: 54, browseKey: "Gastric", alwaysShow: false },
  { id: "Pancreatic", label: "Pancreas", side: "right", topPct: 45, anchorPct: 52, browseKey: "Pancreatic", alwaysShow: true },
  { id: "Colorectal", label: "Colorectal", side: "right", topPct: 53, anchorPct: 55, browseKey: "Colorectal", alwaysShow: true },
  { id: "Ovarian", label: "Ovarian", side: "right", topPct: 58, anchorPct: 53, browseKey: "Ovarian", alwaysShow: false },
] as const;
